...
class Images_Loader {
	 ...
	 * @param	object		$component		A reference to the instance of the object on which the action is
	 *										defined.
	 * @param	string		$callback		The name of the function definition on the $component.
	 * @param	int			$priority		Optional. The priority at which the function should be fired. Default
	 *										is 10.
